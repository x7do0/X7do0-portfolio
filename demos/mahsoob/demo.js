(() => {
  ...
  const i18n = {
    ar: { portfolio:'البورتفوليو',sample:'بيانات تجريبية فقط',reset:'إعادة التجربة',store:'متجر محسوب التجريبي',offline:'يعمل محلياً · بدون إنترنت',cashier:'الكاشير',catalog:'المنتجات',reports:'التقارير',goal:'هدف التجربة',goalCopy:'أضف منتجاً للسلة، أدخل المبلغ المستلم، ثم أكمل البيع وشاهد الإيصال.',cashierTitle:'نقطة البيع',cashierCopy:'الباركود والسلة والدفع في شاشة واحدة.',ready:'جاهز للبيع',quickProducts:'منتجات سريعة',quickCopy:'اضغط على أي منتج لإضافته للسلة.',barcode:'الباركود',add:'إضافة',cart:'السلة',items:'عنصر',clear:'تفريغ',total:'الإجمالي',received:'المبلغ المستلم',change:'الباقي',complete:'إكمال البيع',receiptDemo:'إيصال تجريبي',thanks:'شكراً لزيارتكم',newSale:'عملية جديدة',emptyTitle:'السلة فارغة',emptyCopy:'اختر منتجاً أو أدخل باركود تجريبي.',notFound:'الباركود غير موجود في بيانات الـDemo.',added:'تمت إضافة المنتج إلى السلة.',needCash:'أدخل مبلغاً مستلماً يساوي الإجمالي أو يزيد عليه.',done:'تمت عملية البيع التجريبية.' },
