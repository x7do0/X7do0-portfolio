(() => {
  ...
  const translations = {
    ar: {
      ...
      demoGoalText: "أنشئ طلباً كموظف، أرسله، ثم بدّل إلى المدير ووافق عليه.",
      newRequest: "طلب جديد",
      myRequests: "طلباتي",
      ...
      employeeDashboardDescription: "تابع طلباتك وأنشئ طلباً جديداً للتجربة.",
      ...
      emptyEmployeeCopy: "أنشئ طلباً جديداً حتى تبدأ دورة الموافقة.",
      emptyManagerTitle: "لا توجد طلبات للمراجعة",
      emptyManagerCopy: "ارجع إلى دور الموظف وأنشئ طلباً ثم أرسله للمراجعة.",
