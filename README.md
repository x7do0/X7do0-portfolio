...
العناصر التي لا تملك محتوى حقيقياً معتمداً تبقى مخفية عن الزائر بدل عرض Placeholder أو Coming Soon.
...
- فحص عدم وجود Horizontal Overflow.
- فحص صفحات المشاريع والـResume والروابط العامة الأساسية.
- فحص `robots.txt` و`sitemap.xml`.
- E2E لكل Interactive Demo.
- الجولات القديمة تُلغى تلقائياً عند وصول Commit أحدث لنفس الـPR حتى لا تتراكم اختبارات قديمة.

## SEO / Crawl Policy

- `sitemap.xml` يفهرس الصفحة الرئيسية وResume وصفحات المشاريع الأربعة مع بدائل العربية والإنكليزية.
- الـInteractive Demos لا تدخل في الـsitemap لأنها محاكاة تجريبية وليست صفحات المحتوى الأساسية.
- `robots.txt` يمنع زحف محركات البحث إلى `/demos/` ويرشدها إلى الـsitemap الرسمي.
